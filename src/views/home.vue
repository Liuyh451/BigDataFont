<template>
  <el-container>
    ...
    <el-container>
        ...
        >
          <el-submenu index="1">
            <template slot="title">
              ...
              <el-menu-item index="">训练集量为1000</el-menu-item>
              <el-menu-item index="1-2">训练集量为1000</el-menu-item>
              <el-menu-item index="1-2">训练集量为1000</el-menu-item>     
          </el-submenu>
          <el-submenu index="2">
            <template slot="title">
            ...
            <el-menu-item index="/singlelabel">单独标签</el-menu-item>
      ...
      <el-main>
        <el-row :gutter="5">
          <el-col :span="6" style="width: 410px"
...
export default {
    ...
    return {
      chartData: {
        ...
        rows: [
          ...
          { 算法: "决策树", precision: 0.8, recall: 0.74, F1score: 0.76 },
  ...
  created() {
    var 类2 = {};
    (类2.columns = ["number", "authentication"]), (类2.rows = []);
    let categorySecond = {
      categorySecond: {
        政治新闻: 6542,
        经济新闻: 8523,
    ...
    var valarray = namearray.map(function (i) {
      return c2[i];
    });
